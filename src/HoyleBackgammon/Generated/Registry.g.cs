...
public static class Registry
{
    ...
    [
        new("player-count", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.PlayerCount.Locator]),
        new("men-count", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.MenCount.Locator]),
        new("board-tables", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.BoardTables.Locator]),
        new("point-designations", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.PointDesignations.Locator]),
        new("inner-table-handedness", EntryStatus.Declined, CorrespondenceRow.BeyondAdapter, [MapEntries.InnerTableHandedness.Locator]),
        new("starting-position", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.StartingPosition.Locator]),
        new("opening-roll", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.OpeningRoll.Locator]),
        new("opening-thrower-option", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.OpeningThrowerOption.Locator]),
        new("calling-the-throw", EntryStatus.Declined, CorrespondenceRow.ScopeOut, [MapEntries.CallingTheThrow.Locator]),
        new("throw-two-dice", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.ThrowTwoDice.Locator]),
        new("move-by-pip", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.MoveByPip.Locator]),
        new("direction-of-travel", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.DirectionOfTravel.Locator]),
        new("doublets", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.Doublets.Locator]),
        new("legal-destination", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.LegalDestination.Locator]),
        new("made-point", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.MadePoint.Locator]),
        new("blot-hit", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.BlotHit.Locator]),
        new("enter-from-bar", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.EnterFromBar.Locator]),
        new("full-table-suspension", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.FullTableSuspension.Locator]),
        new("must-play-whole-throw", EntryStatus.Implemented, CorrespondenceRow.UnresolvedAmbiguity, [MapEntries.MustPlayWholeThrow.Locator]),
        new("bearing-off-eligible", EntryStatus.Implemented, CorrespondenceRow.UnresolvedAmbiguity, [MapEntries.BearingOffEligible.Locator]),
        new("bearing-off-move-or-remove", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.BearingOffMoveOrRemove.Locator]),
        new("bearing-off-highest", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.BearingOffHighest.Locator]),
        new("bearing-off-doublets", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.BearingOffDoublets.Locator]),
        new("win-condition", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.WinCondition.Locator]),
        new("game-value", EntryStatus.Implemented, CorrespondenceRow.UnresolvedAmbiguity, [MapEntries.GameValue.Locator]),
        new("agreed-backgammon-multiple", EntryStatus.Implemented, CorrespondenceRow.Assertion, [MapEntries.AgreedBackgammonMultiple.Locator]) { AssertedBy = ["caller"] },
        new("stake-multiplier", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.StakeMultiplier.Locator]),
        new("hit-pays-single-stake", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.StakeMultiplier.Locator, MapEntries.AgreedBackgammonMultiple.Locator]),
        new("next-game-opening", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.NextGameOpening.Locator]),
        new("rubber-scoring", EntryStatus.Implemented, CorrespondenceRow.UnresolvedAmbiguity, [MapEntries.RubberScoring.Locator]),
        new("die-faces", EntryStatus.Implemented, CorrespondenceRow.None, [MapEntries.DieFaces.Locator]),
        new("doubling-cube", EntryStatus.Declined, CorrespondenceRow.ScopeOut, [MapEntries.DoublingCube.Locator]),
        new("strategy-advice", EntryStatus.Declined, CorrespondenceRow.ScopeOut, [MapEntries.StrategyAdvice.Locator]),
    ];
