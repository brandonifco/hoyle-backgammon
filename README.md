...
**Provenance.** `provenance.json` records the run. This tree was produced by rules-factory 0.6.0
(tag `factory/v0.6.0`, commit `ec6294a`, clean) from `RulesFactory.Maps.HoyleBackgammon` 6.0.0.
